...
<div class="margin-top_10 flex items-center justify-center">
    <div class="w-full max-w-md p-8 bg-white shadow-lg rounded-2xl">
        <h2 class="text-2xl font-bold text-center text-gray-900">Cacdastro de usuarios</h2>

        <form class="mt-4 space-y-4" method="POST" action="{{ route('admin.users.creatpost') }}">
            @csrf
